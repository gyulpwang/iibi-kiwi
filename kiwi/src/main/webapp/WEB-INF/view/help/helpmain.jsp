		...
		<div class="row">
						...
						<div class="form-group" align="left">
							<div class="input-group input-group-md">
								<input type="text" id="keyword" name="keyword"
									class="form-control" placeholder="요청하기를 검색해보세요!"> <span
			...
			<div class="col-md-9">
				<div class="row">
					...
					<div class="col-md-3" style="margin-right: 0px; padding: 0px">
						<table class="table table-responsive" style="border-style: none;">
							<tr>
								...
								<c:forEach var="help" items="${helpList}">
									<tr>
										...
										<td width="30%" class="text-center"><a
											href="helpDetail.do?helpidx=${help.helpidx}">${help.title}</a>
											<c:if
												test="${loginMember eq null && loginAdmin != null && loginAdmin.aemail eq 'admin'}">
												<a href="/KIWI/admin/help/delete.do?tnum=${t.tnum}"
													data-toggle="tooltip" title="도움삭제"> <i
