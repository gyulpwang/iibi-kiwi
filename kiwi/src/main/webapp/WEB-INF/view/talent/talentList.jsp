...
<div class="cover">
	...
	<div class="cover-image"
		style="background-image: url('../images/talent/talent_banner/0.jpg')"></div>
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center"
				...
				<p>
					<span style="font-size: medium; color: #fff">하단의 재능분류를 선택하시면
						조회가 가능합니다!</span>
				</p>
				<br>
							...
							<div class="form-group" align="left">
								<div class="input-group input-group-md">
									<input type="text" id="keyword" name="keyword"
										class="form-control" placeholder="재능을 검색해보세요!"> <span
										class="input-group-btn"> <a class="btn btn-success"
										role="button" onclick="javascript:searchT()"><i
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6" style="padding: 0">
							<div style="border-style: solid; padding: 0.5em; margin: 0.1em; border-color: #ded; border-radius: 10px" align="center">
								...
								<div class="project-name row" align="center">
									...
									&nbsp;&nbsp; ￦ <fmt:formatNumber pattern="###,###" value="${t.tprice}" />&nbsp;/&nbsp; ${t.seller}
